...
import { getTrabajos, actualizarTrabajo, aprobarTrabajo, marcarCompletado, agregarMaterial } from '../../api/maestranza'
          ...
          <div key={t.id} className="bg-white rounded-lg shadow p-4">
            ...
            {estaEnEdicion ? (
              <div className="border-t pt-3 mt-2 flex flex-col gap-3 bg-gray-50 -mx-4 -mb-4 p-4 rounded-b-lg">
                ...
                {/* Botón de completar, solo aparece con 100% de avance */}
                {listoParaCompletar && (
